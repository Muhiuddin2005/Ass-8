...
const ErrorPage = () => {
    return (
        <div className='flex flex-col gap-7 py-7 items-center justify-center'>
            ...
            <div>
                <button className="rounded-[0.4rem] bg-gradient-to-br from-[#632EE3] to-[#9F62F2] flex flex-row justify-center items-center gap-[1rem] px-[1.6rem] py-[1.2rem]">Go Back!</button>
            </div>
        </div>
    );
};
